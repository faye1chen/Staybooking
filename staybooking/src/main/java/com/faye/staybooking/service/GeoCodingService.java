...
import com.faye.staybooking.exception.GeoCodingException;
import com.faye.staybooking.exception.InvalidStayAddressException;
import com.faye.staybooking.model.Location;
    ...
    public Location getLatLng(Long id, String address) throws GeoCodingException {
        try {
            ...
            if (result.partialMatch) {
                throw new InvalidStayAddressException("Failed to find stay address");//address is not valid
            }
